...
const PopupMenu = ({children, onClose}) => {
    ...
    return (
        ...
        style={{ height: '100dvh' }}
        >
            <div className={` w-full border-[0.1px] ${toggleThemeMode=="dark"?"border-gray-700/50":"border-gray-300/30"} max-w-[400px] ${toggleThemeMode=="dark"?"bg-gray-900 text-gray-200":"bg-gray-100 text-gray-900"}  p-6 rounded-xl shadow-lg `}>
                    {children}
            </div>
        </div>
    )
