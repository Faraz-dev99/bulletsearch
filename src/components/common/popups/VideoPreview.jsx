...
const VideoPreview = ({ onClose, video, videoLink, videoTitle, videoDesc }) => {
  return (
    <div className="relative w-full max-w-3xl mx-auto bg-gray-100 dark:bg-gray-900 rounded-lg  overflow-hidden">
      ...
      <div className="p-4">
        ...
        <button
          type='button'
          className="dark:bg-gray-600 w-full dark:hover:bg-gray-600/80 text-sm bg-gray-300 hover:bg-gray-200 py-2 px-3 rounded-md cursor-pointer transition"
          onClick={onClose}
        >
          Cancel
        </button>
